...
{
    [TestMethod]
    public void CalculateEachPersonTips_Method_Receives_Only_One_Person_And_Then_Returns_Correct_Calculated_Tip()
    {
    ...
    [TestMethod]
    public void CalculateEachPersonTips_Method_Receives_More_Than_One_Person_And_Then_Returns_Correct_Individual_Tip()
    {
        TipCalculator tipCalculator = new TipCalculator();
    ...
    [TestMethod]
    public void CalculateEachPersonTips_Method_Receives_No_One_Wants_To_Give_Tip_Then_Returns_Zero_Individual_Tip()
    {
        TipCalculator tipCalculator = new TipCalculator();
   
        var IndividualMealCosts = new Dictionary<string, decimal> { { "Meet", 748m }, { "Tarang", 121m } };
        
        var actualTips = tipCalculator.CalculateEachPersonTips(IndividualMealCosts, 0);

        var expectedTips = new Dictionary<string, decimal> { { "Meet", 0 }, { "Tarang", 0 } };
